...
exports.postRegister = async(req,res)=>{
    ...
    try{
        ...
        try{
            ...
            await userModel.addUser(name,email,hashedPassword,type,gender,birthday);
...
exports.updateUser = async(req,res)=>{
    ...
    try{
        const result = await userModel.updateuser(name,gender,birthday,address,req.user._id);
